Feature: Test Panopticon API
  Scenario: NX calls web service to add new transaction
	Given do transaction with {"creditAccountId":"acct8","debitAccountId":"acct9","instrumentId":"EUR","amount":"1","instructionReference":"bdd_test1","instructingParty":"nxchange","instructionLocation":"nxchange"}

Feature: Test Panopticon API
  Scenario: NX calls web service to add new transaction
	Given do transaction with {"creditAccountId":"acct9","debitAccountId":"acct8","instrumentId":"EUR","amount":"1","instructionReference":"bdd_test1","instructingParty":"nxchange","instructionLocation":"nxchange"}
